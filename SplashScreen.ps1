...
<Window 
  ...
  Title="$($app.Title)" WindowStyle="None" WindowState="Maximized" Topmost="False" Background="White">
      ...
      <Border BorderBrush="#333" BorderThickness="0 1 0 1" Grid.Row="1">
        <DockPanel HorizontalAlignment="Stretch" VerticalAlignment="Stretch" Background="White">
          <StackPanel HorizontalAlignment="Center" VerticalAlignment="Center">
            <TextBlock Name="SplashTitle" FontSize="24" Margin="2">$($app.Title)</TextBlock>
...
"@
        ...
        $app.TimerAction = { $app.TimeLabel.Text = [string]::Format("Elapsed Time: {0:00}:{1:00}:{2:00}", `
